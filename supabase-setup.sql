...
VALUES
  ('a', 1, 'Knie & Onderlichaam', 'Groen', '#22c55e', 'bg-green-50', 'Quadriceps + heupabductoren + excentrische controle voor bergaf lopen', true),
...
VALUES
  ...
  ('a6', 'a', 6, 'Wall Sit', '4', NULL, '30-45 sec', 'Quads + Billen', 'Rug tegen muur. Zak tot een hoek die pijnvrij voelt. Houd vast zonder bewegen. Duw rug plat tegen de muur.', 'Isometrisch werk kan de knie rustig laten voelen. Begin met 20-30 sec als 45 sec te veel is.', 'Niet te diep zakken als dat kniepijn geeft. Knieën volgen je tenen, rug blijft plat.', 'Een muur', NULL, true),
  ...
  ('a8', 'a', 8, 'Step-Downs / Heel Taps', '3', '6-10x per been', NULL, 'Quadriceps + Kniecontrole', 'Sta op een lage step of traptrede. Het trainende been blijft op de verhoging. Zak in 3 seconden omlaag tot je andere hak net de vloer tikt. Kom rustig terug omhoog.', 'Dit is de meest specifieke oefening voor bergaf lopen: je traint het remmen. Begin met een lage verhoging.', 'Knie niet naar binnen laten vallen. Knie blijft boven je tweede/derde teen. Niet hoger beginnen dan je controle aankan.', 'Lage step/traptrede', 'Bergaf-blok', true),
  ('a9', 'a', 9, 'Supported Split Squat', '3', '6-8x per kant', NULL, 'Quads + Billen + Balans', 'Sta in split-stance met hand aan muur of stoel. Zak in 3 seconden omlaag binnen een pijnvrije range. Duw rustig terug omhoog.', 'Zie dit als gecontroleerd sterker worden, niet als diep lunges doen. Klein bereik is prima zolang de knie stabiel blijft.', 'Niet doorzakken of snelheid gebruiken. Voorste knie volgt je tenen en blijft rustig.', 'Muur of stoel', 'Bergaf-blok', true),
  ('a10', 'a', 10, 'Lateral Band Walk', '3', '12-20 stappen', NULL, 'Heupabductoren', 'Band boven je knieën of rond je enkels. Kleine squat, voeten parallel. Stap zijwaarts met spanning op de band en houd je knieën naar buiten gericht.', 'Heupcontrole voorkomt dat je knie naar binnen zakt bij lopen, trappen en afdalen.', 'Niet met je romp zwabberen of je voeten naar buiten draaien. Kleine, nette stappen.', 'Rekband', 'Bergaf-blok', true),
  ('a11', 'a', 11, 'Slow Calf Raises', '3', '10-15x', NULL, 'Kuiten + Enkelcontrole', 'Sta rechtop bij muur of stoel. Kom omhoog op je tenen, pauzeer kort, zak in 3 seconden gecontroleerd terug.', 'Je kuit helpt met afremmen bij afdalen. Later kun je dit op één been doen.', 'Niet terug laten vallen op je hakken. Houd de beweging langzaam en symmetrisch.', 'Muur of stoel', 'Bergaf-blok', true),
